...
def test_plugin_properly_detects_errors() -> None:
    ...
    assert b"tests/fixtures/invalid_flake_file.py:3:22: TAN002:" in stdout
    assert b"tests/fixtures/invalid_flake_file.py:4:17: TAN002:" in stdout
    ...
    assert b"tests/fixtures/invalid_flake_file.py:7:26: TAN002:" in stdout
    assert b"tests/fixtures/invalid_flake_file.py:8:21: TAN002:" in stdout
    assert b"tests/fixtures/invalid_flake_file.py:8:26: TAN002:" in stdout
    assert b"tests/fixtures/invalid_flake_file.py:18:25: TAN002:" in stdout
    assert b"tests/fixtures/invalid_flake_file.py:18:43: TAN002:" in stdout
